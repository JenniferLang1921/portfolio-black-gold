    ...
    <div id="contact" className="w-full lg:h-screen ">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          {/*left */}
          <div className="col-span-3 lg:col-span-2 w-full h-full border-[#c5aa73] border-2 mt-10 rounded-xl p-4">
            <div className="lg:p-4 h-full">
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-4">
                  <div className="rounded-full border-[#c5aa73] border-2 p-4 mx-1 cursor-pointer hover:scale-110 ease-in duration-75">
          ...
          {/*right */}
          <div className="col-span-3 w-full h-full border-[#c5aa73] border-2 mt-10 rounded-xl lg:p-4">
            <div className="p-4">
              <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <button className="w-full p-4 border-[#c5aa73] border-2 bg-gradient-to-r from-[#c5aa73] to-[#6e5e40] text-black-100 mt-4 hover:bg-gradient-to-l">
                  Send Message
                </button>
              </form>
            </div>
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full border-[#c5aa73] border-2 p-6 mt-10 cursor-pointer hover:scale-110 ease-in duration-75">
              <HiOutlineChevronDoubleUp className="text-[#c5aa73]" size={30} />
            </div>
          </Link>
        </div>
      </div>
